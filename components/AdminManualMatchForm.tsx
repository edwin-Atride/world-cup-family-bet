  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <input
          className="rounded-2xl px-4 py-3 bg-white/95 text-fifaBlue placeholder:text-fifaBlue/50 outline-none"
        ...
        <input
          className="rounded-2xl px-4 py-3 bg-white/95 text-fifaBlue outline-none"
          type="datetime-local"
          value={kickoff}
      ...
      <button
        className="w-full rounded-2xl bg-fifaGold text-fifaBlue font-black p-4"
        disabled={loading}
      >
